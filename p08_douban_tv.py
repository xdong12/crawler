...
# @Author: Xie1
# @Time: 19-4-8 11:10
# @File: p08_douban_tv.py

url = """
https://m.douban.com/rexxar/api/v2/subject_collection/tv_korean/items?os=ios&for_mobile=1&callback=jsonp1&start=0&count=18&loc_id=108288&_=0
"""
...
class DoubanTV(object):
    ...
    def __init__(self):
        ...
        # 准备URL
        self.url = 'https://m.douban.com/rexxar/api/v2/subject_collection/tv_korean/items?os=ios&for_mobile=1&&start={}&count=18&loc_id=108288&_=0'
    ...
    def save_data(self, data):
        ...
        with open('json/p08_.jsonlines', 'a', encoding='utf8') as f:
            for movie in data:
